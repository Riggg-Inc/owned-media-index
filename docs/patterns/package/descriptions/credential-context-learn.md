---
description: "The Credential-Context-Learn description pattern used by The Diary Of A CEO. Opens with guest credentials, sets the context, then lists what you'll learn."
---
...
1. **Why should I trust this person?** — The credential opens with authority
2. **What is this about?** — The context frames the conversation
3. **What will I get?** — The "you'll learn" list makes the value explicit
...
>
> You'll learn:
> - Why you only have 3–5 seconds to earn attention, and what that changes about your opening lines
> - How dopamine fasting actually works and why most people do it wrong
> - The link between social media use and clinical depression
> - One daily practice that can reset your brain's reward system
...
>
> You'll learn:
> - Why saying no to a $300M acquisition offer was the hardest and best decision he ever made
> - How different leadership styles create different outcomes
> - What it really takes to build companies that last
> - The moment he realized he was the biggest bottleneck in his own company
...
>
> You'll learn:
> - The "Lonely Chapter" framework — why isolation is sometimes the price of growth
> - The "Region Beta Paradox" — why moderate pain keeps you stuck longer than severe pain
> - Why "boring victories" compound faster than dramatic breakthroughs
> - How to design your year around 3 non-negotiable commitments
...
- When the guest lacks a strong credential — switch to [Guest Story Arc](guest-story-arc.md) instead
- When the episode is exploratory with no clear takeaways — use [Big Question Summary](big-question-summary.md)
- When brevity matters more than depth — use [Thesis-Takeaways-CTA](thesis-takeaways-cta.md)

## Related Patterns

- [Problem-Credibility-Takeaway](problem-credibility-takeaway.md) — leads with audience pain instead of guest credential
- [Guest Story Arc](guest-story-arc.md) — narrative-driven instead of credential-driven
- [Authority Claim](../titles/authority-claim.md) — the title pattern that pairs naturally with this description format
