...
This section focuses on the **Publish** actions. See [Content Memory Standard](../../../patterns/preserve/content-memory-standard.md) for the Preserve layer.

## Patterns in This Section

| Pattern | What It Covers |
|---|---|
| [Structured Data](structured-data.md) | Schema.org markup for episodes, guests, and shows |
| [Transcript Optimization](transcript-optimization.md) | Making transcripts AI-parseable and citable |
| [Show Notes for LLMs](show-notes-for-llms.md) | Structuring show notes so AI systems can extract answers |
| [Citation Architecture](citation-architecture.md) | Making your content citable in AI-generated answers |
| [Platform Visibility](platform-visibility.md) | How to appear in Google AI Overviews, Perplexity, ChatGPT, Bing Copilot |
| [Measurement](measurement.md) | Tracking AI search visibility and citation performance |
